...
function reference_data_update(url, auth, auth_cb, timeout, async_job_check_time_ms, service_version) {
    var self = this;
    ...
    var _auth_cb = auth_cb;
     ...
     this.fix_genome_taxonomies = function (params, _callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "reference_data_update.fix_genome_taxonomies",
    ...
    this.status = function (_callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "reference_data_update.status",
